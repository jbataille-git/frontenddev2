...
const showNewItem = function(newItem) {
 ...
 // ----------------------------------------------------------------------------
const addItem = function (item) {   // BL parameter item komt niet terug, kan dus zonder: const addItem = () => {}

  let itemText = document.getElementById("new-item-text").value;  // BL een const ipv let
...
doWork().then( result => processResult(result));  // BL naam is te algemeen
